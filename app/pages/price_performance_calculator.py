...
with mcol0:
    ...
    model_a_throughput_MI300X = st.number_input(label='MI300X Throughput', key='ma11-input', min_value=0.0, step=1.0, value=1.0)
    model_a_throughput_MI325X = st.number_input(label='MI325X Throughput', key='ma12-input', min_value=0.0, step=1.0, value=1.0)
    model_a_throughput_H100 = st.number_input(label='H100 Throughput', key='ma13-input', min_value=0.0, step=1.0, value=1.0)
    model_a_throughput_H200 = st.number_input(label='H200 Throughput', key='ma14-input', min_value=0.0, step=1.0, value=1.0)
...
with mcol1:
    ...
    model_b_throughput_MI300X = st.number_input(label='MI300X Throughput', key='ma21-input', min_value=0.0, step=1.0, value=1.0)
    model_b_throughput_MI325X = st.number_input(label='MI325X Throughput', key='ma22-input', min_value=0.0, step=1.0, value=1.0)
    model_b_throughput_H100 = st.number_input(label='H100 Throughput', key='ma23-input', min_value=0.0, step=1.0, value=1.0)
    model_b_throughput_H200 = st.number_input(label='H200 Throughput', key='ma24-input', min_value=0.0, step=1.0, value=1.0)
...
with mcol2:
    ...
    model_c_throughput_MI300X = st.number_input(label='MI300X Throughput', key='ma31-input', min_value=0.0, step=1.0, value=1.0)
    model_c_throughput_MI325X = st.number_input(label='MI325X Throughput', key='ma32-input', min_value=0.0, step=1.0, value=1.0)
    model_c_throughput_H100 = st.number_input(label='H100 Throughput', key='ma33-input', min_value=0.0, step=1.0, value=1.0)
    model_c_throughput_H200 = st.number_input(label='H200 Throughput', key='ma34-input', min_value=0.0, step=1.0, value=1.0)
...
with mcol3:
    ...
    model_d_throughput_MI300X = st.number_input(label='MI300X Throughput', key='ma41-input', min_value=0.0, step=1.0, value=1.0)
    model_d_throughput_MI325X = st.number_input(label='MI325X Throughput', key='ma42-input', min_value=0.0, step=1.0, value=1.0)
    model_d_throughput_H100 = st.number_input(label='H100 Throughput', key='ma43-input', min_value=0.0, step=1.0, value=1.0)
    model_d_throughput_H200 = st.number_input(label='H200 Throughput', key='ma44-input', min_value=0.0, step=1.0, value=1.0)
...
with mcol4:
    ...
    model_e_throughput_MI300X = st.number_input(label='MI300X Throughput', key='ma51-input', min_value=0.0, step=1.0, value=1.0)
    model_e_throughput_MI325X = st.number_input(label='MI325X Throughput', key='ma52-input', min_value=0.0, step=1.0, value=1.0)
    model_e_throughput_H100 = st.number_input(label='H100 Throughput', key='ma5-input', min_value=0.0, step=1.0, value=1.0)
    model_e_throughput_H200 = st.number_input(label='H200 Throughput', key='ma54-input', min_value=0.0, step=1.0, value=1.0)
